    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingOne" style="border-bottom: none">
            <h4 class="panel-title">
                <?= '<b>'.$model->customer_name .'</b>, '. Yii::$app->formatter->asDate($model->date) . ', Total : ' . Yii::$app->formatter->asDecimal($total_order, 0) ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            ...
            if ($modelItem->isNewRecord) {
                ...
                echo Html::a('<i class="glyphicon glyphicon-remove"></i> ' . Yii::t('app', 'Cancel'), ['update', 'id' => $model->id], [
                    'class' => 'btn btn-default delete-item',
                ])
                . ' ' . Html::submitButton('<i class="glyphicon glyphicon-ok"></i> ' . Yii::t('app', 'Edit'), ['class' => 'btn btn-primary']);
                echo "</div>";
            }
            ?>
            </div>
                ...
                echo \kartik\grid\GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($data) {
                                return 
                                Html::a('<i class="glyphicon glyphicon-pencil"></i>', ['update', 'id' => $data->order_id, 'order_item_id' => $data->id], [
