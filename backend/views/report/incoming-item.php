...
<style>
    ...
    &nbsp;&nbsp;&nbsp;<a href="<?= Url::to(['/report/incoming',
        'date_start'    => $date_start,
        'date_end'      => $date_end,
        'supplier_id'   => $supplier_id,
    ]) ?>" class="btn btn-default"><i class="fa fa-th"></i> Pembelian </a>
    ...
    <div class="printable">
        ...
        ?>
            <tr>
                ...
                <?php if (!$supplier_id) { ?><td><?= $model->incoming->supplier ? $model->incoming->supplier->name : '' ?></td><?php } ?>
