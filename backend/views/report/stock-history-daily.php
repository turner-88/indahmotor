    ...
    <div class="printable">
        ...
        <?php } else { ?>
            ...
            foreach ($models as $model) {
                if ($model['sum_quantity_in'] > $model['sum_quantity_out']) {
            ?>
                <tr>
                    <td class="text-right" style="width:1px"><?= ++$i ?></td>
                    <td class=""><?= $model['shortcode'] ?></td>
                    <td class=""><?= $model['name'] ?></td>
                    <td class=""><?= $model['brand'] ?></td>
                    <td class=""><?= $model['type'] ?></td>
                    <td class="text-right"><?= Yii::$app->formatter->asDecimal($model['sum_quantity_in'], 0) ?></td>
                    <td class="text-right"><?= Yii::$app->formatter->asDecimal($model['sum_quantity_out'], 0) ?></td>
                    <td class="text-right"><?= Yii::$app->formatter->asDecimal($model['sum_quantity_in'] - $model['sum_quantity_out'], 0) ?></td>
