...
<div class="customer-index box-- box-primary-- box-body--">
    ...
    <?php 
        $exportColumns = [
            ...
            'phone',
            'person_in_charge',
            'priceGroup.name:text:Price group',
            'salesman.name:text:Salesman',
            'payment_limit_duration',
            'created_at:datetime',
            'updated_at:datetime',
        ...
        $gridColumns = [
            ...
            [
                ...
                'filter' => ArrayHelper::map(PriceGroup::find()->orderBy('name')->asArray()->all(), 'id', 'name'), 
            ...
            [
                'attribute' => 'payment_limit_duration',
                'format' => 'integer',
