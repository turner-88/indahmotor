...
<div class="col-md-8 col-sm-12">
    ...
    <?= $form->field($model, 'outgoing_type_id')->widget(Select2::classname(), [
        'data' => ArrayHelper::map(OutgoingType::find()->all(), 'id', 'name'),
        'options' => ['placeholder' => ''],
    ...
    <?= $form->field($model, 'incoming_item_id')->widget(Select2::classname(), [
        'data' => ArrayHelper::map(IncomingItem::find()->all(), 'id', 'name'),
        'options' => ['placeholder' => ''],
        'pluginOptions' => ['allowClear' => true],
    ]); ?>
