...
<div class="outgoing-index box-- box-primary-- box-body--">
    ...
    <?php 
        $exportColumns = [
            ...
            'incomingItem.name:text:Incoming item',
        ...
        $gridColumns = [
            ...
            [
                'attribute' => 'outgoing_type_id',
                'value' => 'outgoingType.name',
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => ArrayHelper::map(OutgoingType::find()->orderBy('name')->asArray()->all(), 'id', 'name'), 
                'filterInputOptions'=>['placeholder'=>''],
                'filterWidgetOptions' => [
            ...
            [
                'attribute' => 'incoming_item_id',
                'value' => 'incomingItem.name',
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => ArrayHelper::map(IncomingItem::find()->orderBy('name')->asArray()->all(), 'id', 'name'), 
                'filterInputOptions'=>['placeholder'=>''],
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear'=>true],
                ],
