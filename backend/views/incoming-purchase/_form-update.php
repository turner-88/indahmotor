...
<div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne" style="border-bottom: none">
        <h4 class="panel-title">
            <?= 'Rp ' . Yii::$app->formatter->asDecimal($model->total, 0) . ' : <b>' . $model->supplier->shortText .'</b>, <small>'. Yii::$app->formatter->asDate($model->date) .' &raquo; '. Yii::$app->formatter->asDate($model->due_date).'</small>' ?>
