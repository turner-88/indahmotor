...
<div class="incoming-index box-- box-primary-- box-body--">
    ...
    <?php 
        ...
        $gridColumns = [
            ...
            [
                ...
                'format'              => 'html',
                'filterType'          => GridView::FILTER_SELECT2,
                'filter'              => Incoming::paymentStatuses(),
                'filterInputOptions'  => ['placeholder' => ''],
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
    ...
    <?= GridView::widget([
        ...
        'bordered' => false,
        'toolbar'=> [
            Html::a('<i class="fa fa-plus"></i> ' . 'Pembelian Baru', ['create'], ['class' => 'btn btn-success']),
            Html::a('<i class="fa fa-repeat"></i> ' . 'Reload', ['index'], ['data-pjax'=>0, 'class'=>'btn btn-default']),
            // '{toggleData}',
            // $exportMenu,
            Html::a('<i class="fa fa-th-list"></i> ' . 'Lihat Detail', ['/incoming-item/index'], ['data-pjax'=>0, 'class'=>'btn btn-default']),
