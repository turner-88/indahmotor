...
<div class="col-md-8 col-sm-12">
    ...
    <?= $form->field($model, 'order_id')->widget(Select2::classname(), [
        'data' => ArrayHelper::map(Order::find()->all(), 'id', 'id'),
        'options' => ['placeholder' => ''],
    ...
    <?= $form->field($model, 'to_be_ordered')->textInput() ?>
    ...
    <?= $form->field($model, 'item_shortcode')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'brand_storage')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'brand_supplier')->textInput(['maxlength' => true]) ?>
