...
/* @var $searchModel backend\models\IncomingPaymentSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Incoming Payment';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="incoming-payment-index box-- box-primary-- box-body--">
    ...
    <?php 
        ...
        $gridColumns = [
            ...
            [
                ...
                'filter' => ArrayHelper::map(Incoming::find()->orderBy('serial')->asArray()->all(), 'id', 'serial'), 
            ...
            [
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => ArrayHelper::map(PaymentType::find()->orderBy('name')->asArray()->all(), 'id', 'name'), 
                'filterInputOptions'=>['placeholder'=>''],
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear'=>true],
                ],
