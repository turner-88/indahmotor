...
<div class="supplier-index box-- box-primary-- box-body--">
        ...
        $gridColumns = [
            ...
            [
                ...
                'value' => function($model) {
                    return Incoming::find()->where(['supplier_id' => $model->id])->sum('cast(total as integer) - cast(total_payment as integer)');
                }
            ],
            // 'created_at:integer',
            // 'updated_at:integer',
