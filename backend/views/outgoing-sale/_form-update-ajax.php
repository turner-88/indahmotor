...
<div class="incoming-form">
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingOne" style="border-bottom: none">
            ...
            <?= Html::a('<i class="glyphicon glyphicon-print"></i>', ['print', 'id' => $model->id, 'to_pdf' => 1], [
                ...
                &nbsp;
                <?= 
                    'Rp <span class="text-total">' . Yii::$app->formatter->asDecimal($model->total, 0) . '</span>'
    ...
    <?= Html::activeHiddenInput($modelItem, 'outgoing_id') ?>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                <label class="control-label col-sm-2" style="padding-left:0; padding-right:0">Kode</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" style="padding-left:0; padding-right:0">Nama</label>
                <div class="col-sm-10">
                    <?= Html::textInput('item_name', null, ['class' => 'form-control', 'id' => 'item_name']) ?>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" style="padding-left:0; padding-right:0">Merk</label>
                <div class="col-sm-10">
        ...
        <div class="col-sm-2" style="padding-right:0">
            ...
            <div class="form-group">
                <label class="control-label col-sm-5" style="padding-left:0; padding-right:0">Qty <span id="unitofmeasurement-label"></span></label>
                <div class="col-sm-7">
                    <?= Html::activeTextInput($modelItem, 'quantity', ['class' => 'form-control', 'style' => 'text-align:right']) ?>
                </div>
            </div>
            <!-- <div class="form-group">
                <label class="control-label col-sm-5" style="padding-left:0; padding-right:0">Satuan</label>
                <div class="col-sm-7">
                    <?= Html::textInput('item_unit_of_measurement', null, ['class' => 'form-control', 'id' => 'item_unit_of_measurement']) ?>
                </div>
            </div> -->
            <div class="form-group">
                <label class="control-label col-sm-5" style="padding-left:0; padding-right:0">Type</label>
                <div class="col-sm-7">
                    <?= Html::textInput('item_type', null, ['class' => 'form-control', 'id' => 'item_type']) ?>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-5" style="padding-left:0; padding-right:0">Hrg Terakhir</label>
                <div class="col-sm-7">
                    <?php // echo Html::textInput('last_price', null, ['class' => 'form-control', 'id' => 'last_price', 'readonly' => true, 'style' => 'font-weight:bold; color:red; text-align:right']) ?>
                    <div id="last_price" class="form-control" style="font-weight:bold; color:red; text-align:right" readonly></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-2" style="padding-right:0">
            <div class="form-group">
                <label class="control-label col-sm-5" style="padding-left:0; padding-right:0">Disc</label>
                <div class="col-sm-7">
                    <?= Html::activeTextInput($modelItem, 'discount', ['class' => 'form-control', 'style' => 'text-align:right']) ?>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-5" style="padding-left:0; padding-right:0">Harga</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label class="control-label col-sm-5" style="padding-left:0; padding-right:0">Hrg Modal</label>
                <div class="col-sm-7">
                    <?php // echo Html::textInput('base_price', null, ['class' => 'form-control', 'id' => 'base_price', 'readonly' => true, 'style' => 'font-weight:bold; color:red; text-align:right']) ?>
                    <div id="base_price" class="form-control" style="font-weight:bold; color:red; text-align:right" readonly></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-2">
            ...
            <div class="pull-right"><span>List: <span id="gross_price">-</span></span></div>
            <div>Net: <span id="net_price">-</span></div>

            <div>
                <!-- <label>PRICE GROUP</label> -->
                <div class="detail-view-container" style="background:#f4f4f4">
                    <table class="table table-condensed small" style="margin:0; margin-bottom:2px">
                        <!-- <tr>
                            <td></td>
                            <td>Discount</td>
                            <td>Price</td>
                    ...
                    foreach (($priceGroups = PriceGroup::find()->all()) as $priceGroup) {
                        ...
                        <tr class="price-group-<?= $priceGroup->name ?>" style="background: <?= $background ?>">
                            <td style="padding:0 5px" class="text-center action-column">&nbsp;&nbsp;<b><?= $priceGroup->name ?></b></td>
                            <td style="padding:0 5px" class="text-right">
                                <span id="<?= $priceGroup->name . '-discount' ?>"></span>
                            </td>
                            <td style="padding:0 5px" class="text-right" width="55%">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2">Box</label>
                ...
                echo \kartik\grid\GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($data) {
                                return 
                                Html::a('<i class="glyphicon glyphicon-pencil"></i>', ['update-ajax', 'id' => $data->outgoing_id, 'outgoing_item_id' => $data->id], [
