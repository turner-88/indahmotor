...
/**
 * IncomingSearch represents the model behind the search form about `backend\models\Incoming`.
 */
class IncomingSearch extends Incoming
{
    ...
    {
        return [
            [['id', 'incoming_type_id', 'supplier_id', 'storage_id', 'customer_id', 'outgoing_item_id', 'salesman_id', 'payment_status', 'is_deleted', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
