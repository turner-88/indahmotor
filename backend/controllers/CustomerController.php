...
class CustomerController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if (($groupless_count = Customer::find()->where(['price_group_id' => null])->count()) > 0) {
            Yii::$app->session->addFlash('warning', $groupless_count . ' customer belum masuk kelompok harga manapun.');
        }
    ...
    public function actionSetPayment($id)
    {
