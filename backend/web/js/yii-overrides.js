...
$(document).keydown(function(e) {
    if (e.keyCode == 77 && e.ctrlKey) {
        ...
        if ($('#myModal').hasClass('in')) {
            $('#myModal :input[type=text]:enabled:visible:first').focus().focusTextToEnd();
        }

        if ($('#myModal2').hasClass('in')) {
            $('#myModal2 :input[type=text]:enabled:visible:first').focus().focusTextToEnd();
        }
    }
});
...
.on('keyup', filter_selector, delay(function(event) {
    // if ((event.keyCode >= 49 && event.keyCode <= 90) || event.keyCode == 173 || event.keyCode == 188 || (event.keyCode >= 190 && event.keyCode <= 192) || (event.keyCode >= 219 && event.keyCode >= 222) || event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 46 || event.keyCode == 13) {
    if (event.keyCode == 13) {
...
.on('keyup', filter_selector2, delay(function(event) {
    // if ((event.keyCode >= 49 && event.keyCode <= 90) || event.keyCode == 173 || event.keyCode == 188 || (event.keyCode >= 190 && event.keyCode <= 192) || (event.keyCode >= 219 && event.keyCode >= 222) || event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 46 || event.keyCode == 13) {
    if (event.keyCode == 13) {
        input = $(this).attr('name');
        if(submit_form === false) {
