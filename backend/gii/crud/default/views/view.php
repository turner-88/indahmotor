...
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-view box-- box-info--">
    ...
    if (($tableSchema = $generator->getTableSchema()) === false) {
        ...
        foreach ($generator->getTableSchema()->columns as $column) {
            ...
            if ($column->name == 'id') {
                ...
                echo "                '" . lcfirst(Inflector::camelize(rtrim($column->name, '_id'))) . ".name:text:" . ucwords(Inflector::humanize(rtrim($column->name, '_id'))) . "',\n";
